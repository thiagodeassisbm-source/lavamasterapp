...
import { FileText, Plus, Clock, CheckCircle, XCircle, Trash2, UserPlus } from 'lucide-react';
...
export default function OrcamentosClient({ initialOrcamentos }: OrcamentosClientProps) {
    ...
    const handleSave = async (data: any) => {
        try {
            ...
            showToast('Erro', error.message || 'Erro ao salvar orçamento.', 'error');
        }
    };
    ...
    const totalPendentes = orcamentos.filter(o => o.status === 'pendente').reduce((acc, o) => acc + (Number(o.valor) || 0), 0);
    const totalAprovados = orcamentos.filter(o => o.status === 'aprovado').reduce((acc, o) => acc + (Number(o.valor) || 0), 0);
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    ...
                    <div className="glass-effect rounded-2xl p-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-slate-400 text-sm">Total Aprovado</p>
